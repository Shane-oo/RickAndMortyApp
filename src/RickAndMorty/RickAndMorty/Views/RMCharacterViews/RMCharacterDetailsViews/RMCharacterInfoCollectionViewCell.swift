...
final class RMCharacterInfoCollectionViewCell: UICollectionViewCell {
    ...
    private let iconImageView: UIImageView = {
        ...
        icon.image = UIImage(systemName: "location.viewfinder")
    ...
    private func addConstraints(){
        NSLayoutConstraint.activate([
            titleContainerView.leftAnchor.constraint(
                equalTo: contentView.leftAnchor
            ),
            titleContainerView.rightAnchor.constraint(
            ...
            titleLabel.leftAnchor.constraint(
                equalTo: titleContainerView.leftAnchor
            ),
            titleLabel.rightAnchor.constraint(
                equalTo: titleContainerView.rightAnchor
            ),
